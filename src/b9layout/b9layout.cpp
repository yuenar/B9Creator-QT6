 ...
 * 模块名称:    b9layout
 * 文件名:     b9layout.cpp
 * 模块功能:   布局管理模块实现文件，包含B9Layout主窗口类的具体实现
 * 创建者:    owenzhang
 * 创建日期:    2026-03-15
 * 版本号:     V1.0.0
 * 历史记录:
...
void B9Layout::SetXYPixelSizePreset(int index)
{
    // 根据索引获取对应的像素大小
    QString size;
    switch(index) {
...
void B9Layout::BuildInterface()
{
    ...
    // 手动连接pixelsizecombo信号，避免UI文件自动生成的问题
    QObject::connect(ui.pixelsizecombo, SIGNAL(currentIndexChanged(int)), this, SLOT(SetXYPixelSizePreset(int)));
