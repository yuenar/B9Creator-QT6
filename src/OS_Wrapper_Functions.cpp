 ...
 * 模块名称:    utils
 * 文件名:     OS_Wrapper_Functions.cpp
 * 模块功能:   操作系统包装函数实现文件，包含跨平台兼容性函数的具体实现
 * 创建者:    owenzhang
 * 创建日期:    2026-03-15
 * 版本号:     V1.0.0
 * 历史记录:
...
QString CROSS_OS_GetDirectoryFromLocationTag(QString locationtag)
{
    //确保路径存在。
        ...
        QString tempPath = QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/B9Creator";
        QDir().mkpath(appDataPath);
        QDir().mkpath(documentsPath + "/B9Creator");
